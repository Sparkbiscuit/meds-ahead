...
final class PrescriptionLabelEndToEndTests: XCTestCase {
    ...
    func testAPharmacyIsNotInventedAndAFaxOrNPIIsNotItsPhone() {
        ...
        let hospital = ScanParser.parse(evidence(["BOSTON CHILDREN'S HOSPITAL PHARMACY", "617-355-6000", "TACROLIMUS 1 MG CAPSULE"]))
        XCTAssertEqual(hospital.pharmacyName, "Boston Children's Hospital Pharmacy")
        XCTAssertEqual(hospital.pharmacyPhone, "(617) 355-6000")
