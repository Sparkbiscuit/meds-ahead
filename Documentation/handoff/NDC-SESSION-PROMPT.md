...
Every bottle we have — retail and hospital-pharmacy vials
alike — prints an **NDC**. That is an exact product identifier: manufacturer,
...
- Verify by running things, not by believing worker reports. Tests:
  ...
  220 pass as of commit `718f1c9`. Never pipe xcodebuild through `head` — SIGPIPE
...
a caregiver with no time to spare — could use it easily, quickly,
